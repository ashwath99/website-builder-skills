...
| -------------------------------- | -------------------------------- | --------------- |
| Heading font (`font-heading`)    | `design_guide.md` Section 1, 3.1 | `{PLACEHOLDER}` |
| Heading font CDN URL             | `design_guide.md` Section 3.1    | `{PLACEHOLDER}` |
...
| Token                  | Placeholder In                | Value           |
| ---------------------- | ----------------------------- | --------------- |
| `color-primary`        | `design_guide.md` Section 2.1 | `{PLACEHOLDER}` |
...
These values are structural CSS constants defined in `design_guide.md` and are NOT in this file because they are universal:
